...
public class Coleman {
    void coleman(int characters, int sentences, int word) {
        double averageWord =(double) word / 100;
        double averageCharacters = characters / averageWord;
        double averageSentences = sentences/averageWord;
        double score =0.0588*averageCharacters-0.296*averageSentences-15.8;
        ...
        switch (zzz) {
            ...
            case 12:
                ...
                break;
            case 13:
                System.out.println("(about 19-24-year-olds).");
                break;
            case 14:
